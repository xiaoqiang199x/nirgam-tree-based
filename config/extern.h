...
extern int path_len, manhattan_len;
extern int non_optimal_count;
extern int maximum;
extern int minimum;
extern int genbe;
extern int gengt;
...
// Tree-based routing id imformation
extern UI tree_id_no_fault_X[];
extern UI tree_id_no_fault_Y[];

...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file MYTREE_router.h
/// \brief Defines class to implement XY routing algorithm
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef __MYTREE_router__
#define __MYTREE_router__
...
//////////////////////////////////////////////////////////////////////
/// brief Class to implement MYTREE routing algorithm
///
/// inherited from from class router
//////////////////////////////////////////////////////////////////////
class MYTREE_router : public router {
	public:
		/// Constructor
		MYTREE_router() { }
	    ...
	    UI calc_next(UI ip_dir, ULL src_id, ULL src_idX, ULL src_idY, ULL dst_id, ULL dst_idX, ULL dst_idY);

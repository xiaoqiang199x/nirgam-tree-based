...
#include "MYTREE_router.h"
#include "../../config/extern.h"

////////////////////////////////////////////////
/// Method to set unique id
////////////////////////////////////////////////
void MYTREE_router::setID(UI id_tile, vector<UI> t_id) {
    id = id_tile;
    tree_id = t_id;
    tree_idX = t_id[0];
    tree_idY = t_id[1];
...
UI MYTREE_router::calc_next(UI ip_dir, ULL source_id, ULL source_idX, ULL source_idY, ULL dest_id, ULL dest_idX, ULL dest_idY) {

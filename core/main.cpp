    ...
    else
    {
        ...
        while (!fil1.eof())
        {
            ...
            else if (name=="RT_ALGO")
            {
                ...
                ///////
                //SINGLE_TREE//
                else if (name== "SINGLE_TREE")
                    RT_ALGO= SINGLE_TREE;
                //DOUBLE_TREE//
                else if (name== "DOUBLE_TREE")
                    RT_ALGO= DOUBLE_TREE;
                //MY_TREE//
                else if (name== "MY_TREE")
                    RT_ALGO= MY_TREE;
...
//******************************************************************
    ...
    // * * * *
    // * * * *
    //UI tree_id_tmp_X[] = { 311,   11,  411, 4411,
    //                        31,    1,   41,  441,
    //                         3,    0,    4,   44,
    //                        32,    2,   42,  442};
    //UI tree_id_tmp_Y[] = { 113,   11,  114, 1144,
    //                        13,    1,   14,  144,
    //                         3,    0,    4,   44,
    //                        23,    2,   24,  244};
    ...
    //                         3,    0,    4,   44,
    //                        32,    2,   42,  442};
    //UI tree_id_tmp_Y[] = { 113,   11,  411, 1144,
    //                        13,    1,    5,  144,
    //                         3,    0,    4,   44,
    //                        23,    2,   24,  244};

    // ---------- 2 fault node - node 6/8 ----------
    // * * * *
    // * * X *
    // X * * *
    // * * * *
    UI tree_id_tmp_X[] = { 311,   11,  411, 4411,
                            31,    1,    5,  144,
                             5,    0,    4,   44,
                            32,    2,   42,  442};
    UI tree_id_tmp_Y[] = { 131,   11,  411, 1144,
                            31,    1,    5,  144,
                             5,    0,    4,   44,
                            32,    2,   24,  244};

    //vector<UI> tree_id(num_rows*num_cols); 
    vector<vector<UI> > tree_id(num_rows*num_cols); 
    // resize the vector
    ...
    for(int i=0; i<num_rows*num_cols; i++)
    {
        tree_id[i][0] = tree_id_tmp_X[i];
        tree_id[i][1] = tree_id_tmp_Y[i];
    }

    // create NoC model
    NoC noc("noc", num_rows, num_cols, tree_id);
    // connect clock
    ...
    results_log<<"\nOverall average path strech = "<< ((float)path_len/manhattan_len)<<endl;
    results_log<<"\nOverall non-optimal fraction = "<< ((float)non_optimal_count/total_flits_recvd)<<endl;
    cout <<"\n\033[32mOverall average path strech = "<< ((float)path_len/manhattan_len)<<"\033[0m"<<endl;
    cout <<"\n\033[32mOverall non-optimal fraction = "<< ((float)non_optimal_count/total_flits_recvd)<<"\033[0m"<<endl;
    if (qos==1)
    {

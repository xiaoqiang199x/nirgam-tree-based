...
struct InputChannel : public sc_module {
	...
	sc_out<sc_uint<ADDR_SIZE> > destRequestX;	///< output port to send destination address to Controller
	sc_out<sc_uint<ADDR_SIZE> > destRequestY;	///< output port to send destination address to Controller
	sc_out<sc_uint<ADDR_SIZE> > sourceAddress;	///< output port to send source address to Controller
	sc_out<sc_uint<ADDR_SIZE> > sourceAddressX;	///< output port to send source address to Controller
	sc_out<sc_uint<ADDR_SIZE> > sourceAddressY;	///< output port to send source address to Controller

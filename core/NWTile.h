...
struct NWTile : public BaseNWTile {
	...
	NWTile(sc_module_name NWTile, UI tileID, vector<vector<UI> > tree_id);

	// PROCESSES //////////////////////////////////////////////////////////////////////////////////////////
	void entry();		///< Writes buffer utilization information at the tile, at each clock cycle
	void setID(UI, vector<vector<UI> >);		///< sets unique tile id and associates ports with directions
...
// PROCESS END /////////////////////////////////////////////////////////////////////////////////////
	...
	sc_signal<sc_uint<ADDR_SIZE> > destReqX[num_ic];
	sc_signal<sc_uint<ADDR_SIZE> > destReqY[num_ic];
	/// Source address from IC to Ctr
	sc_signal<sc_uint<ADDR_SIZE> > srcAddr[num_ic];
	sc_signal<sc_uint<ADDR_SIZE> > srcAddrX[num_ic];
	sc_signal<sc_uint<ADDR_SIZE> > srcAddrY[num_ic];
